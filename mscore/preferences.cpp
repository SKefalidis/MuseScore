...
void Preferences::init(bool storeInMemoryOnly)
      ...
      _allPreferences = prefs_map_t(
      {
            ...
            {PREF_PAN_MODIFIER_BASE,                               new DoublePreference(1, false)},
            {PREF_PAN_MODIFIER_STEP,                               new DoublePreference(0.01, false)},
            {PREF_PAN_MODIFIER_MIN,                                new DoublePreference(0, false)},
            {PREF_PAN_MODIFIER_MAX,                                new DoublePreference(5, false)},
            ...
            {PREF_PAN_CURSOR_VISIBLE,                              new BoolPreference(false, false)},
            {PREF_PAN_SMART_TIMER_DURATION,                        new IntPreference(1000, false)},
            {PREF_PAN_CURSOR_POS,                                  new DoublePreference(0.3, false)},
#ifdef AVSOMR
